  ...
  <div class="flex h-screen bg-gray-50 text-gray-900">
    ...
    <div class="flex-1 flex flex-col">
      <header class="flex justify-between items-center bg-white border-b border-gray-200 px-6 py-4 shadow-sm">
        <h2 class="text-xl font-semibold text-gray-700">Panel del Comprador</h2>
...
const links = [
  { label: 'Inicio', to: '/dashboard/buyer' },
  { label: 'Publicación', to: '/dashboard/buyer/publication' },
  { label: 'Gestión', to: '/dashboard/buyer/management' },
]
